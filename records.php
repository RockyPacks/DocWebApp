<div id="records-section" class="bg-white rounded-lg shadow-sm overflow-hidden fade-in">
    <div class="p-6 border-b border-gray-200 flex justify-between items-center">
        <h2 class="text-xl font-semibold text-gray-800">Patient Records</h2>
        <div class="flex items-center">
            <span class="text-sm text-gray-500 mr-2">Total Patients:</span>
            <span id="patient-count" class="font-medium">0</span>
        </div>
    </div>
    ...
    <div class="overflow-x-auto">
        <table id="patient-table" class="min-w-full divide-y divide-gray-200">
            ...
            <tbody id="patient-table-body" class="bg-white divide-y divide-gray-200">
                <tr>
                    <td colspan="8" class="px-6 py-4 text-center text-gray-500">No patients found. Add a new patient to get started.</td>
                </tr>
            </tbody>
        </table>
    </div>
